...
t = np.linspace(0,0.5,200-1) 

coop112  = list(np.loadtxt('cooperation112.txt'))
coop112.pop(0)
coop112.pop(0)
alpha112 = list(np.loadtxt('alphaIn112.txt'))
alpha112.pop(0)
alpha112.pop(0)
coop114  = list(np.loadtxt('cooperation114.txt'))
coop114.pop(0)
coop114.pop(0)
alpha114 = list(np.loadtxt('alphaIn114.txt'))
alpha114.pop(0)
alpha114.pop(0)

coop132  = list(np.loadtxt('cooperation122.txt'))
coop132.pop(0)
coop132.pop(0)
alpha132 = list(np.loadtxt('alphaIn122.txt'))
alpha132.pop(0)
alpha132.pop(0)
coop134  = list(np.loadtxt('cooperation124.txt'))
coop134.pop(0)
coop134.pop(0)
alpha134 = list(np.loadtxt('alphaIn124.txt'))
alpha134.pop(0)
alpha134.pop(0)

coop122  = list(np.loadtxt('cooperation132.txt'))
coop122.pop(0)
coop122.pop(0)
alpha122 = list(np.loadtxt('alphaIn132.txt'))
alpha122.pop(0)
alpha122.pop(0)
coop124  = list(np.loadtxt('cooperation134.txt'))
coop124.pop(0)
coop124.pop(0)
alpha124 = list(np.loadtxt('alphaIn134.txt'))
alpha124.pop(0)
alpha124.pop(0)
...
for i, ax in enumerate(axs):
    ...
    ax.set_xticklabels(['2', '101', '200']) 
    # ax.axhline(0.0,color='k', alpha=0.3)
    ax.set_xlabel(r'population size $(N)$',size=14)
    ax.text(dis, 1-dis, f'({chr(97 + i)})', transform=ax.transAxes, va='top', ha='left',size=15)  # Add (a), (b), (c) text
    ax.set_aspect(ar)
