...
x1 = np.loadtxt("mInformationW112.txt")
x3 = np.loadtxt("mInformationW122.txt")
x2 = np.loadtxt("mInformationW132.txt")

y1 = np.loadtxt('capacityW112.txt')
y3 = np.loadtxt('capacityW122.txt')
y2 = np.loadtxt('capacityW132.txt')
############################### data ###############
...
# Adjust layout
plt.tight_layout()
plt.savefig('discount_alter.pdf')
