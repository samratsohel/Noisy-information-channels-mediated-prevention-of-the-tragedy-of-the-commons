...
////////////////////////////////////////////////////////////////////////
void symmetricErrorChannelsTrajGen(int scheme,int strategyClass,int qvecNo,double eps,double n,double w,double beta, const std::string& filename1,const std::string& filename2)
{
	...
	VectorXd nITalpha(nGEN);
	VectorXd nITmIn(nGEN);
...
void DissymmetricErrorChannelsSpace(int scheme,int strategyClass,int qvecNo,double eps,double beta,const std::string& filename1,const std::string& filename2,const std::string& filename3)
{
	...
	ofstream file3;
	file3.open(filename3);
	for (double P = 1.0; P < 11.0+dxP; P += dxP)
	{
		double delta = (1.0-(1.0/pow(10,P)));
		for (double n = 0; n < 0.5+dx; n += dx)
		{
			double c = 0;
			double alphaIn = 0;
...
void trajDataParamsSave(int scheme)
{
	...
	symmetricErrorChannelsTrajGen(scheme,2, 1, eps, 0.5, 0, beta, "withNoise112.txt","withNoise112a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 2, eps, 0.5, 0, beta, "withNoise122.txt","withNoise122a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 3, eps, 0.5, 0, beta, "withNoise132.txt","withNoise132a1.txt");

	symmetricErrorChannelsTrajGen(scheme,4, 1, eps, 0.5, 0, beta, "withNoise114.txt","withNoise114a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 2, eps, 0.5, 0, beta, "withNoise124.txt","withNoise124a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 3, eps, 0.5, 0, beta, "withNoise134.txt","withNoise134a1.txt");

	symmetricErrorChannelsTrajGen(scheme,2, 1, eps, 0.0, 0, beta, "withOutNoise112.txt","withOutNoise112a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 2, eps, 0.0, 0, beta, "withOutNoise122.txt","withOutNoise122a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 3, eps, 0.0, 0, beta, "withOutNoise132.txt","withOutNoise132a1.txt");

	symmetricErrorChannelsTrajGen(scheme,4, 1, eps, 0.0, 0, beta, "withOutNoise114.txt","withOutNoise114a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 2, eps, 0.0, 0, beta, "withOutNoise124.txt","withOutNoise124a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 3, eps, 0.0, 0, beta, "withOutNoise134.txt","withOutNoise134a1.txt");
}
////////////////////////////////////////////////////////////////////////
...
void trajDataParamsSaveW(int scheme)
{
	...
	// symmetricErrorChannelsTrajGen(scheme, strategyClass, qvecNo, eps, n, w, beta, "filename.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 1, eps, 0, 0.5, beta, "withNoise112.txt","withNoise112a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 2, eps, 0, 0.5, beta, "withNoise122.txt","withNoise122a1.txt");
	symmetricErrorChannelsTrajGen(scheme,2, 3, eps, 0, 0.5, beta, "withNoise132.txt","withNoise132a1.txt");

	symmetricErrorChannelsTrajGen(scheme,4, 1, eps, 0, 0.5, beta, "withNoise114.txt","withNoise114a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 2, eps, 0, 0.5, beta, "withNoise124.txt","withNoise124a1.txt");
	symmetricErrorChannelsTrajGen(scheme,4, 3, eps, 0, 0.5, beta, "withNoise134.txt","withNoise134a1.txt");
